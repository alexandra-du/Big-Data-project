...
<h2><font color="teal">2.2) Model that includes the relevant parameters in predicting the value</font></h2>
```{r}
...
#<font color="blue">5) Conclusions </font>

Among 3 classifiers, KNN succeeds in reaching the highest precision (KNN:92.6%; LDA:86.7%; LR:65.7%) and we decide to choose KNN because of its accuracy of prediction.
